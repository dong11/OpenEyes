...
import com.rex.hwong.openeyes.ui.widget.media.IRenderView;
import com.rex.hwong.openeyes.ui.widget.media.IjkVideoView;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity) {
        ...
        videoView = (IjkVideoView) activity.findViewById(R.id.ijkVideoView);
...
//                        Toaster.show("download rate:" + extra);
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus==STATUS_COMPLETED) {
            Log.e("PlayerManager","statusChange STATUS_COMPLETED...");
            if (playerStateListener != null){
                playerStateListener.onComplete();
            }
        }else if (newStatus == STATUS_ERROR) {
            Log.e("PlayerManager","statusChange STATUS_ERROR...");
            if (playerStateListener != null){
...
//            $.id(R.id.app_video_loading).visible();
            ...
            Log.e("PlayerManager","statusChange STATUS_LOADING...");
        } else if (newStatus == STATUS_PLAYING) {
            Log.e("PlayerManager","statusChange STATUS_PLAYING...");
            if (playerStateListener != null){
    ...
    private void onVolumeSlide(float percent) {
        ...
        Log.e("PlayerManager","onVolumeSlide:"+s);
    }
    ...
    private void onProgressSlide(float percent) {
        ...
        if (showDelta != 0) {
            ...
            Log.e("PlayerManager","onProgressSlide:" + text);
        }
    }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        Log.e("PlayerManager","brightness:"+brightness+",percent:"+ percent);
